...
import backgroundImage from '../assets/HeroSection/Image/HeroSection1.jpg';

import { motion } from 'framer-motion';
 
const HeroSectionHome3 = () => {
  ...
  return (
    <>
      <div
        className="bg-cover bg-center min-h-[90vh] flex items-center mt-8"
        style={{
...
export default HeroSectionHome3;
